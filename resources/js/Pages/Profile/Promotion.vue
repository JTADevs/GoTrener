<script setup>
    ...
    const purchasePlan = async () => {
        ...
        try {
            ...
            await axios.post('/profile/promotion', {
                package: {
    ...
    <ProfileLayout>
        <div class="bg-gray-100 flex-1 flex flex-col">
            <div class="flex flex-col lg:flex-row flex-1">
                <SidebarNav :user="user" activeView="promowanie" @change-view="changeView" />
                <main class="flex-1 md:p-4 lg:p-8">
                    <div class="w-full max-w-[1000px] mx-auto pb-12">
                        <div class="py-6 space-y-8 pb-24">
                            <div class="text-center space-y-4">
                                <h1 class="text-3xl font-bold text-gray-800">Promuj swój profil i zdobywaj nowych podopiecznych</h1>
                            ...
                            <div v-else-if="plans.length === 0" class="text-center py-12 text-gray-500 bg-white rounded-2xl shadow-lg p-8">
                            ...
                            <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                >
                                    ...
                                    <button class="w-full py-3 px-4 rounded-xl font-bold text-gray-900 transition-colors duration-200 cursor-pointer"
                            ...
                            >
                                <div v-if="selectedPlan" id="plan-summary" class="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-50 md:sticky md:bottom-4 md:rounded-2xl md:shadow-xl md:border-none">
