...
<template>
    <div class="min-h-screen bg-gray-50 pb-12">
        <!-- Header Banner -->
        <header class="bg-[#241F20] text-white py-8 px-6 shadow-lg mb-8">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
                    ...
                    <Form @submit.prevent="form.post('/profil/update', { forceFormData: true })" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" id="city" v-model="form.city" @input="handleCityChange" list="city-suggestions" placeholder="Wpisz miasto..." class="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-xl focus:ring-2 focus:ring-[#F5F570] focus:border-[#F5F570] transition-colors outline-none">
            ...
            <div v-if="user.role === 'trainer'" class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="p-6 md:p-8">
                    <Form @submit.prevent="galleryForm.post('/profil/gallery', { forceFormData: true, onSuccess: () => galleryForm.reset() })" class="space-y-6">
                        <div class="w-full border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:bg-gray-50 transition-colors relative">
                             <input 
                                ...
                                class="hidden"
                            />
                            <label for="gallery-upload" class="cursor-pointer block w-full">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="p-6 md:p-8">
                    <Form @submit.prevent="scoreForm.put('/profil/updateScore')" class="space-y-8">
